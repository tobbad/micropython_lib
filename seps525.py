...
class SEPS525():
    ...
    def __circle(self, x0:int, y0:int, r:int):
        # adapted from https://github.com/elfnor/micropython-blog-examples/blob/master/oled/lcd_gfx.py
    ...
    def line(self, x0, y0, x1, y1, color):
        # copy from https://github.com/elfnor/micropython-blog-examples/blob/master/oled/lcd_gfx.py
